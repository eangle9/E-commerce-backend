...
func (c colorService) GetColors(ctx context.Context, request request.PaginationQuery, requestID string) (response.Response, error) {
	page := request.Page
	...
	colors, err := c.colorRepo.ListColors(ctx, offset, perPage, requestID)
	if err != nil {
